...
function fnVisualize(data, seaScape){
  ...
  var maxValue = d3.max(seaScapeDataVisual.join, join => join.visible ? join.dataRow.value : 0);	
  var minValue = d3.min(seaScapeDataVisual.join, join => join.visible ? join.dataRow.value : maxValue);
